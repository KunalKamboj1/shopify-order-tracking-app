...
var ESCAPE_LOOKUP2, ESCAPE_REGEX2;
...
import(${JSON.stringify(manifest.entry.module)});`;
  ...
  let nextMatches = React3.useMemo(() => {
    if (navigation.location) {
      ...
      invariant3(matches2, `No routes match path "${navigation.location.pathname}"`);
      return matches2;
    }
    return [];
...
function createServerRoutes(manifest, routeModules, future, parentId = "", routesByParentId = groupRoutesByParentId2(manifest)) {
  return (routesByParentId[parentId] || []).map((route) => {
...
function createClientRoutesWithHMRRevalidationOptOut(needsRevalidation, manifest, routeModulesCache, initialState, future) {
  return createClientRoutes(manifest, routeModulesCache, initialState, future, "", groupRoutesByParentId2(manifest), needsRevalidation);
}
...
function createClientRoutes(manifest, routeModulesCache, initialState, future, parentId = "", routesByParentId = groupRoutesByParentId2(manifest), needsRevalidation) {
  return (routesByParentId[parentId] || []).map((route) => {
...
var React7, prevRefreshReg, prevRefreshSig, _s, router, routerInitialized, hmrAbortController, hmrRouterReadyResolve, hmrRouterReadyPromise, criticalCssReducer, _c;
...
var React9, import_server2;
var init_server2 = __esm({
  "node_modules/@remix-run/react/dist/esm/server.js"() {
    React9 = __toESM(require_react());
    import_server2 = __toESM(require_server());
    init_components();
    init_errorBoundaries();
    init_routes2();
  }
...
@remix-run/react/dist/esm/index.js:
   ...
   *)
*/
//# sourceMappingURL=/build/_shared/chunk-BJ3XLEYR.js.map
